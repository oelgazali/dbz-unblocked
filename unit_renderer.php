var jvx_6823e29bac57cNonMraidTagInMraidEnv = false;
var jvx_6823e29bac57cdyPropsACK = false;
...
(function(){
	if(typeof MRAID_ENV != 'undefined'){
		...
		jvx_6823e29bac57cNonMraidTagInMraidEnv = true;
	}
})();

if(typeof jvxObjectList == "undefined"){
	var jvxObjectList = ["jvx_6823e29bac57c"];
}else{
	jvxObjectList.push("jvx_6823e29bac57c");
}
    ...
    try{
        ...
        if(cScrNode == undefined){
            ...
            for(var i=0;i<scrNodes.length;i++){
                ...
                if(scrSrc &&  scrSrc.indexOf("https://as.jivox.com/unit/unit_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=363224d40b8d20&campaignId=190954&es_pId=aLcp9rQC&isDynamic=1&jvxVer=2&dspId=Appnexus&cMacro=https%3A%2F%2Fnym2-ib.adnxs.com%2Fclick2%3Fe%3DwqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA%2Fs%3D572e82a45fceb8c6db56568e71db70b014df4ab8%2Fbcr%3DAAAAAAAA8D8%3D%2Fcnd%3D%25217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8.%2Fcca%3DNjY4I05ZTTI6NTM1Mg%3D%3D%2Fbn%3D91054%2Fclickenc%3D&r=612549720&ap_DataSignal6=5996021986718930399&ap_DataSignal7=APN&ap_DataSignal8=310721287&ap_DataSignal9=613953129&ap_DataSignal10=") != -1){
                    cScrNode = scrNodes[i];
                }
            }
        }   
...
function createiFrameNode(obj){
	...
	if(document.body == null){
		document.write("<div id='jvxSkeletonRef_6823e29bac57c' style='display:none;'></div>")
	}
			...
			createImprTrackerFrame = function(frameId){
				...
				function jvx_6823e29bac57cfireImprTracker(url, elType){
			var elNode = null;
			if(elType == 'script'){
							} else {
...
finalURL = replaceCacheBuster4;				//finalURL = replaceCacheBuster;
			...
			if(elType == 'script'){
														imprScrTrackerCnt++;
					var imprFrameId = 'jvx_6823e29bac57cImprTrackerFrame_'+imprScrTrackerCnt;
			...
			function jvx_6823e29bac57cfireIT(){
										jvx_6823e29bac57cfireImprTracker('https://ad.doubleclick.net/ddm/ad/N3093.3325855MIQ/B33107211.413170971;sz=1x1;ord=${CACHEBUSTER};dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755}?', 'img');
																																}
		
				jvx_6823e29bac57cfireIT();
...
function replaceRunTimeMacros( trackerUrl, params){
	try{
		...
		runtimeMacroValues['ah'] = (jvx_6823e29bac57c.baseHeight) ? jvx_6823e29bac57c.baseHeight : (params['clientHeight'] ? params['clientHeight'] : "") ;
		runtimeMacroValues['aw'] =  jvx_6823e29bac57c.baseWidth ? jvx_6823e29bac57c.baseWidth : (params['clientWidth'] ? params['clientWidth'] : "");
		var tv = runtimeMacroValues['ct'] - jvx_6823e29bac57c.layoutLoadedTime;
...
*/
var jvx_6823e29bac57cTraffickedInFrame = false,			// COM: should be true, if !busted and self != top
	jvx_6823e29bac57cSafeFrameSupported = false,		// COM: should be true only when safeFrame is supported in the page
	jvx_6823e29bac57cCanBustFromFrame = true,			// COM: should be false, when all busting method fails
	jvx_6823e29bac57cInNestedFrame = false;				// COM: should be true, when tag trafficked inside nested frame

if(self != top){
	jvx_6823e29bac57cTraffickedInFrame = true;
}

try{
		$sf.ext.register(300, 250);
		jvx_6823e29bac57cSafeFrameSupported = true;
}catch(e){
	jvx_6823e29bac57cSafeFrameSupported = false;
}
...
var adViewabilityDetectInit = function (visibilityThreshold) { 
    try {
        ...
        boxElement = document.querySelector('#adUnitContainer_6823e29bac57c');
                    ...
                    if (!adInVPForOneSec && !timerRunning) {
                        ...
                        timeoutHandle = setTimeout(function () {
                            adInVPForOneSec = true;
                                                        if(typeof jvx_6823e29bac57c != "undefined")
                            jvx_6823e29bac57c.recordEvent(73);
                            else 
                            recordEvent(73);
                                                    }, 1000);
                    }
...
var CreativeUnit = (function(){
	...
	function receiveHtml5Message(e){
        ...
        var s = e.data.split(':', 10);
		        if(s && s.length >= 2 && s[0] == 'jvx_6823e29bac57c'){
			var msg = s[1];
			if(msg == 'openExpansion'){
									jvx_6823e29bac57c.openClickThrough();
							} else if(msg == 'closeExpansion'){
				jvx_6823e29bac57c.closeExpansion(false, false);
			} else if(msg == 'expansionLoaded'){
							} else if(msg == 'recordUIR'){
				jvx_6823e29bac57c.UIRRecorded = true;
			} else if(msg == 'lastMouseLeave'){
				jvx_6823e29bac57c.lastMLeaveId = s[2];
			} else if(msg == 'clearUIR'){
				clearTimeout(jvx_6823e29bac57c.UIRTimer);
			} else if(msg == 'recordDwell'){
				if(!jvx_6823e29bac57c.DwellRecorded){
					jvx_6823e29bac57c.recordDwellEvent(49, jvx_6823e29bac57c.DwellElapsedTime);
				}
			} 
												else if(msg=="dynamicProperties") {
                jvx_6823e29bac57c.updateDYProperties(s[2],1);
							}
			else if(msg=="clickThroughUrl") { 
							
				jvx_6823e29bac57c.clickTagURL = s.slice(2).flat(1).join(":");
			}
			else if(msg == "clickTrackers") {	
								jvx_6823e29bac57c.clickTrackers =  s.slice(2).join(":").split(",").map(function(url){ return decodeURIComponent(url) });
				this.clickTrackers = jvx_6823e29bac57c.clickTrackers;
			}
												                        else if(msg == "miniScrollerBgInfo"){
                var miniScrollerBgURL = decodeURIComponent(s[2]);
                jvx_6823e29bac57c.fixedBgAstLeft = parseInt(s[3]);
                jvx_6823e29bac57c.renderFixedPageBg(miniScrollerBgURL,s[3]);
            } 
		}
	}
	...
	function postHtml5Message(winRef, msg){
		try{
			winRef.postMessage('jvx_6823e29bac57c' + ':' + msg, "*");
		}catch(e){
			if(typeof(winRef.contentWindow) != 'undefined')
				winRef.contentWindow.postMessage('jvx_6823e29bac57c' + ':' + msg, "*");
		}
	}
	...
	*/
	...
	function clearNode(pNode, idPrefix){
        ...
        if(jvx_6823e29bac57cTraffickedInFrame){
                        try{
...
finalURL = replaceCacheBuster4;			//finalURL = replaceCacheBuster;
			...
			if(url.indexOf("?") == -1){
				...
				finalURL = url + "&r=" + Math.random();
					...
					if(typeof jvx_6823e29bac57c != 'undefined' && url.match("https://evs.jivox.com/jivox/serverAPIs/saveImpression.php")){	//Add es_cgName and es_segName params only for the evs trackers URL not for the thirdParty trackers.
				finalURL += "&es_cgName_"+jvx_6823e29bac57c.DYReportingKey;
                if(jvx_6823e29bac57c.DYSegmentName != ""){
                    finalURL += "&es_segName_"+jvx_6823e29bac57c.DYSegmentName;
                }
			}
				imgEl.src = finalURL;
			}       
	...
	function setOpacity(myElement, opacityValue) {
		...
		var cLeft = sfLeft + "px",
			cTop = sfTop + "px",
			cNode = getElById(jvx_6823e29bac57c.adUnitContainerId);
		addStyles(cNode, {"left":cLeft, "top":cTop});
	}
	function renderAdInsideSafeFrame(animDir){
		if(jvx_6823e29bac57cSafeFrameSupported){
			/* ------------- SafeFrame Settings--------------- */
						var ref = jvx_6823e29bac57c,
	 ...
	 /* var rect = obj.getBoundingClientRect();
		...
		var vpStyles = findPos(getElById(jvx_6823e29bac57c.adUnitContainerId)),
			vpTop = "", vpLeft = "";
	...
	function mraidHandleOnViewable(viewable){
		jvxMraidIsShown = viewable;		 
			if(!jvxMraidIsShown || getElById(jvx_6823e29bac57c.baseContainerId)){
				return; 
			}
		jvx_6823e29bac57c.init();
	...
	function handleMraidViewableImprFiring(){
		if (!adInVPForOneSec && !timerRunning) {
			...
			var timeoutHandle = setTimeout(function () {
				adInVPForOneSec = true;
				jvx_6823e29bac57c.recordEvent(74);
			}, 1000);
		}
	}
	...
	function CreativeUnit(uniqId){
	    ...
	    this.id = uniqId;  
		this.playerParamsMap = {"reportingURL":"https:\/\/evs.jivox.com","creativeUnitType":"20","bDim":"300x250","bUnitId":"2000","siteId":"363224d40b8d20","campaignId":"190954","es_pId":"aLcp9rQC","isDynamic":"1","jvxVer":"2","dspId":"Appnexus","cMacro":"https:\/\/nym2-ib.adnxs.com\/click2?e=wqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA\/s=572e82a45fceb8c6db56568e71db70b014df4ab8\/bcr=AAAAAAAA8D8=\/cnd=%217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8.\/cca=NjY4I05ZTTI6NTM1Mg==\/bn=91054\/clickenc=","r":"612549720","ap_DataSignal6":"5996021986718930399","ap_DataSignal7":"APN","ap_DataSignal8":"310721287","ap_DataSignal9":"613953129","ap_DataSignal10":"","0":"","serverURL":"https:\/\/as.jivox.com"};
		this.campaignId = '190954';
		this.siteId = '363224d40b8d20';
		this.placementId = 'aLcp9rQC';
		...
		this.browserVersion = '130.0.0.0';
								this.clickTagURL = 'https://nym2-ib.adnxs.com/click2?e=wqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA/s=572e82a45fceb8c6db56568e71db70b014df4ab8/bcr=AAAAAAAA8D8=/cnd=%217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8./cca=NjY4I05ZTTI6NTM1Mg==/bn=91054/clickenc=';
		this.clickTrackers = [];
		...
		this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=363224d40b8d20&campaignId=190954&es_pId=aLcp9rQC&isDynamic=1&jvxVer=2&dspId=Appnexus&cMacro=https%3A%2F%2Fnym2-ib.adnxs.com%2Fclick2%3Fe%3DwqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA%2Fs%3D572e82a45fceb8c6db56568e71db70b014df4ab8%2Fbcr%3DAAAAAAAA8D8%3D%2Fcnd%3D%25217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8.%2Fcca%3DNjY4I05ZTTI6NTM1Mg%3D%3D%2Fbn%3D91054%2Fclickenc%3D&r=612549720&ap_DataSignal6=5996021986718930399&ap_DataSignal7=APN&ap_DataSignal8=310721287&ap_DataSignal9=613953129&ap_DataSignal10=&objectName=jvx_6823e29bac57c&adUnitId=2000&jvxSessionId=1747182235.1593';
	...
	CreativeUnit.prototype = {
		constructor:CreativeUnit,
         ...
         sendCookieRequest: function(cookieName){
	        if(jvx_6823e29bac57cSafeFrameSupported){
		         var callBackFnName ='jvx_6823e29bac57c'+".updateDYProperties";
		         jvx_6823e29bac57c.addScriptTagToBody('https://as.jivox.com'+"/unit/getCookies.php?cookieName="+cookieName+"&callback="+callBackFnName+"&deleteCookie="+1+"&r_="+Math.random());  
	         }                  
         },
         updateDYProperties: function(val,isNotCookieData){
            ...
            jvx_6823e29bac57c.DYReportingKey = dynPropArr[0] ? decodeURIComponent(dynPropArr[0]) : "";
            jvx_6823e29bac57c.DYSegmentName = dynPropArr[1] ? decodeURIComponent(dynPropArr[1]) : "";
		  jvx_6823e29bac57c.eventServerParams = dynPropArr[2] ? decodeURIComponent(dynPropArr[2]) : "";   //Getting trafficker events output from layout_renderer_html.php
		  jvx_6823e29bac57c.cmUrl = dynPropArr[3] ? decodeURIComponent(dynPropArr[3]) : "";
			jvx_6823e29bac57c.reportingSchema = dynPropArr[4] ? decodeURIComponent(dynPropArr[4]) : "";
            //this.fireCREvent();
			jvx_6823e29bac57cdyPropsACK = true;
         },
			...
			if(doFireCreativeLoadEvt){
				...
				jvx_6823e29bac57c.recordEvent(72, 'es_et=' + creativeLoadElapseTime);
			}
		},
		onLoadEventHandler:function(event){
                    ...
                    if(jvx_6823e29bac57cSafeFrameSupported){
                        var getReportingKeyFromCookie = false,
                            ...
                            if(getReportingKeyFromCookie){
                                jvx_6823e29bac57c.sendCookieRequest('jvx_6823e29bac57c'+"_dynamicProperties");
                            }
                    }
                											}	
		},
			...
			baseContainerNode.appendChild(baseNode);
								...
								jvx_6823e29bac57c.layoutLoadedTime = Date.now();
			...
			var executeCallBack = function(transitionEvt){
					...
					if(ref.expansionOpen){
						...
						if(ref.openExpAgain) ref.openExpAgain = false; 
												...
												if(jvx_6823e29bac57cSafeFrameSupported && transitionEvt){
							try{
								$sf.ext.collapse();
															}catch(e){}
						}
		...
		getIBusterFrameInfo:function(){
			if(typeof(jivoxIBusterAdObject) != "undefined"){
				...
				for(var i=0; i < iFramesLen; i++){
					if(hostIframes[i].contentWindow == jivoxIBusterAdObject["jvx_6823e29bac57c"].foreignWindow){
...
//				e2Node.style.margin = mt + ' 0 0 ' + ml;
		...
		openWindow:function(url){
							if(jvx_6823e29bac57cNonMraidTagInMraidEnv){
					mraid.open(url);
				} else {
					window.open(url);
				}
		...
		openClickThrough:function(event={}){
				...
				if(!this.raiseCMacroFlag){
					var eventRecordParams = "c_cx="+clickEventDetails.clientX+"/c_cy="+clickEventDetails.clientY+"/c_ct="+clickEventDetails.ct+"/c_tv="+(clickEventDetails.ct-jvx_6823e29bac57c.layoutLoadedTime);
					this.recordEvent(1, eventRecordParams);
				}else{
					var eventRecordParams = "es_clkMac_1/c_cx="+clickEventDetails.clientX+"/c_cy="+clickEventDetails.clientY+"/c_ct="+clickEventDetails.ct+"/c_tv="+(clickEventDetails.ct-jvx_6823e29bac57c.layoutLoadedTime);
					this.recordEvent(1, eventRecordParams);
				}
									if(!adInVPForOneSec){
												this.recordEvent(73);
					...
					if(clkTrackers.length != 0){
						for(var tracker of clkTrackers){
							fireTracker(replaceRunTimeMacros(tracker,clickEventDetails));
													...
													fireTracker(replaceRunTimeMacros('https://ad.doubleclick.net/ddm/clk/605113212;413170971;p;gdpr=${GDPR};gdpr_consent=${GDPR_CONSENT_755}', clickEventDetails ));
												}
						},
				openExpansion:function(autoExpand, skipOpenEvent){
			
						
						if(!jvx_6823e29bac57cCanBustFromFrame || jvx_6823e29bac57cInNestedFrame){
				return;
			}
		...
		recordEvent:function(eventId,addnlParams){
											if( !jvx_6823e29bac57cdyPropsACK && (eventId==48 || eventId==49 || eventId==1)){
					addnlParams = (addnlParams) ? addnlParams + "/c_actualEventId="+eventId : "c_actualEventId="+eventId;
					eventId = 78;
				}
								var eventReportingParams = '';
											eventReportingParams = "238983/2000/190954/363224d40b8d20/20/jvxSId_1747182235.1593";		
												var rand = Math.random();
				var imgEl = document.createElement("img");
                var tempURL = "";
                var eventReportingURL = "https://evs.jivox.com/trk" + "/" + eventId + "/" + eventReportingParams;
                eventReportingURL += "/es_pId_aLcp9rQC";
                tempURL += "";
                                tempURL += "/ap_DataSignal6=5996021986718930399/ap_DataSignal7=APN/ap_DataSignal8=310721287/ap_DataSignal9=613953129/ap_DataSignal10=";
                									if(jvx_6823e29bac57c.cmUrl != "" && jvx_6823e29bac57c.cmUrl != undefined){
						tempURL += "/cmUrl=" + encodeURIComponent(jvx_6823e29bac57c.cmUrl);
					}
					if(jvx_6823e29bac57c.eventServerParams != "" && jvx_6823e29bac57c.eventServerParams != undefined){
						tempURL += "/" + jvx_6823e29bac57c.eventServerParams;
					}
				                tempURL = addnlParams ? (tempURL + "/" + addnlParams) : tempURL;
									tempURL += "/bDim="+ "300x250";
								tempURL = tempURL + "/jvxRandom=" + rand;
				//eventReportingURL = (eventId == 1) ? (eventReportingURL + ";https://nym2-ib.adnxs.com/click2?e=wqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA/s=572e82a45fceb8c6db56568e71db70b014df4ab8/bcr=AAAAAAAA8D8=/cnd=%217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8./cca=NjY4I05ZTTI6NTM1Mg==/bn=91054/clickenc=") : eventReportingURL;
									tempURL += "/es_cgName="+jvx_6823e29bac57c.DYReportingKey;
                    if(jvx_6823e29bac57c.DYSegmentName != ""){
                        tempURL += "/es_segName="+jvx_6823e29bac57c.DYSegmentName;
                    }
		...
		recordDwellEvent:function(eventId, elapsedTime){
			...
			this.DwellTimer = null;
						...
						var cNode = createDivNode(this.adUnitContainerId);
			            												document.write('<div id="jvxScrRefNode_6823e29bac57c" style="display:none;"></div>');	
				var jvxPNode = '';
				var jvxNode = getElById("jvxScrRefNode_6823e29bac57c");
			...
			if(bestFitBase) {
				...
				if(this.baseHasLayout == 1) {
					this.baseType = 'html';
					this.baseURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&bUnitId=2000&siteId=363224d40b8d20&campaignId=190954&es_pId=aLcp9rQC&isDynamic=1&jvxVer=2&dspId=Appnexus&cMacro=https%3A%2F%2Fnym2-ib.adnxs.com%2Fclick2%3Fe%3DwqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA%2Fs%3D572e82a45fceb8c6db56568e71db70b014df4ab8%2Fbcr%3DAAAAAAAA8D8%3D%2Fcnd%3D%25217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8.%2Fcca%3DNjY4I05ZTTI6NTM1Mg%3D%3D%2Fbn%3D91054%2Fclickenc%3D&r=612549720&ap_DataSignal6=5996021986718930399&ap_DataSignal7=APN&ap_DataSignal8=310721287&ap_DataSignal9=613953129&ap_DataSignal10=&objectName=jvx_6823e29bac57c';
											this.baseURL += '&jvxSessionId=1747182235.1593';
			...
			if(bestFitExpand) {
				...
				if(this.expansionHasLayout == 1) {
					this.expansionType = 'html';
										var adUnitIdStr = '';
										this.expansionURL = 'https://as.jivox.com/unit/layout_renderer.php?creativeUnitType=20&bDim=300x250&&siteId=363224d40b8d20&campaignId=190954&es_pId=aLcp9rQC&isDynamic=1&jvxVer=2&dspId=Appnexus&cMacro=https%3A%2F%2Fnym2-ib.adnxs.com%2Fclick2%3Fe%3DwqT_3QKjAfBDowAAAAMAxBkFAQiAxY_BBhDfq8G-qMeJm1MYsYmessmaptUuIMim9AgolFcwnAU4AkDp3OCkAkimqIIBUABaA1VTRGIBBfBGaKwCcPoBeKXZmgGAAa7HBYgBAZABAZgBBaABAqkBLuVSLuVS-z-xAWZmZmZm7vE_uQEAAAAA16P0P8EBMjMzMzOT9j_JATMBCjwzAUDYAQDgAQDwAdYB-AEA%2Fs%3D572e82a45fceb8c6db56568e71db70b014df4ab8%2Fbcr%3DAAAAAAAA8D8%3D%2Fcnd%3D%25217xAKxQi9nYwcEOnc4KQCGKaoggEgACgAMQAAAAAAAAAAOglOWU0yOjUzNTJAnklJAAAAAAAA8D9RAAAAAAAAAABZAAAAAAAAAABhAAAAAAAAAABpAAAAAAAAAABxAAAAAAAAAAB4AIkBAAAAAAAA8D8.%2Fcca%3DNjY4I05ZTTI6NTM1Mg%3D%3D%2Fbn%3D91054%2Fclickenc%3D&r=612549720&ap_DataSignal6=5996021986718930399&ap_DataSignal7=APN&ap_DataSignal8=310721287&ap_DataSignal9=613953129&ap_DataSignal10=&objectName=jvx_6823e29bac57c'+adUnitIdStr;
											this.expansionURL += '&jvxSessionId=1747182235.1593';
		...
		listenerCallback:function(event) {
			jvx_6823e29bac57c.eventController(event); 
		},
...
var jvx_6823e29bac57c = new CreativeUnit("_6823e29bac57c");
jvx_6823e29bac57c.DYReportingKey = "";
jvx_6823e29bac57c.DYSegmentName = "";
jvx_6823e29bac57c.eventServerParams = "";
jvx_6823e29bac57c.cmUrl = "";
	if(jvx_6823e29bac57cNonMraidTagInMraidEnv){
				jvx_6823e29bac57c.recordEvent(75);
	}
    jvx_6823e29bac57c.init();
